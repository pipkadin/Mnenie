...
SELECT 
    ...
    1,
    r.ID_RESPONDENTA,
    '2024-01-' || LPAD((1 + (random() * 30)::int)::text, 2, '0') || ' ' || 
    LPAD((8 + (random() * 12)::int)::text, 2, '0') || ':' || 
    LPAD((random() * 60)::int::text, 2, '0') || ':00'
FROM RESPONDENT r
ORDER BY random()
LIMIT 18;
...
SELECT 
    ...
    2,
    r.ID_RESPONDENTA,
    '2024-02-' || LPAD((1 + (random() * 28)::int)::text, 2, '0') || ' ' || 
    LPAD((8 + (random() * 12)::int)::text, 2, '0') || ':' || 
    LPAD((random() * 60)::int::text, 2, '0') || ':00'
FROM RESPONDENT r
ORDER BY random()
...
SELECT 
    ...
    3,
    r.ID_RESPONDENTA,
    '2024-03-' || LPAD((1 + (random() * 31)::int)::text, 2, '0') || ' ' || 
    LPAD((8 + (random() * 12)::int)::text, 2, '0') || ':' || 
    LPAD((random() * 60)::int::text, 2, '0') || ':00'
FROM RESPONDENT r
ORDER BY random()
